...
public class Departements {
    ...
    /**
     * Méthode princiaple de la classe Departements.
     * Créer un objets Departements et invoque les deux méthodes "receiveForDecouverts" et "receiveForInvestissements".
