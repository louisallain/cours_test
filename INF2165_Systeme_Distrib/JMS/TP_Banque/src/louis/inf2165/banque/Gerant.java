...
public class Gerant {
    ...
    public Gerant() {
        ...
        try (InputStream input = new FileInputStream("config.properties")) {
            ...
            if (!admin.addDestination(queue, isQueue)) {
                System.err.println("Impossible de créer cette file (exist-elle déjà ?) : " + queue);
            }
    ...
    public void addCompte(Compte compte) {
        System.out.println("Nouveau compte : \n Client : \n" + compte.getIdClient().toString() + "\nNuméro de compte : " + compte.getNumCompte() + "\n");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Gérant lancé");
