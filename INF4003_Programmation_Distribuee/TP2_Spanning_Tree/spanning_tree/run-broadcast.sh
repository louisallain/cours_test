...
APP_JAR=$HOME/Documents/INF4003_Programmation_Distribuee/TP2_Spanning_Tree/spanning_tree/spanning_tree.jar
...
do
  ...
  ssh $NODE$pid java -cp $CSP_JAR:$APP_JAR $MAIN_CLASS $CONF_FILE $pid 4 &
done
