...
public class BuildNet {
   ...
   * @param id
   */
  public BuildNet(int id, String filename, int nbNodes) {
    
    process_terminated= new Semaphore(0);
    process= new ConcurrentProcess(id,"BuildNet", 12240, nbNodes);
  ...
  public static void main(String[] args){
    ...
    BuildNet buildNet= new BuildNet(my_id, conf_file, nbNodes);
  }
