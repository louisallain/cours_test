 ...
 */
public class SpaceAccessor implements DiscoveryListener {
    ...
    public SpaceAccessor(Class aServiceInterface) {
    ...
    public static JavaSpace getSpace() {
      ...
      SpaceAccessor finder = new SpaceAccessor(JavaSpace.class);
    ...
    public static TransactionManager getManager() {
      System.setSecurityManager(new RMISecurityManager());
      System.out.println("Searching for a Transaction Manager...");
      SpaceAccessor finder = new SpaceAccessor(TransactionManager.class);
      TransactionManager txnManager = (TransactionManager) finder.getService();
      System.out.println("A Transaction Manager has been discovered.");
      return txnManager;
  }
}
