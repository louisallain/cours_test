...
public class Philosopher {
  ...
  private CyclicCounterAccessor cycleCounterAccessor;
  private CyclicCounter cycleCounter;
  ...
  public Philosopher(JavaSpace space, int id, int num) {
    ...
    this.cycleCounterAccessor = new CyclicCounterAccessor(space, "roundRobin", this.number_of_phi); // add
  ...
  private void initSpace() {
    ...
    cycleCounterAccessor.create(); // add
  ...
  private void freeSpace() {
    ...
    CyclicCounterAccessor tmpCCA = new CyclicCounterAccessor(space, "roundRobin", this.number_of_phi); // add
    tmpCCA.waitForTurn(this.phi_id); // add
  }
  ...
  private void waiting(){
    ...
    say("waiting my turn");
    this.cycleCounter = this.cycleCounterAccessor.waitForTurn(this.phi_id);

    say("waiting for a plate");
    plate.down();

    say("passe my turn");
    this.cycleCounterAccessor.passeToNextTurn(this.cycleCounter);
