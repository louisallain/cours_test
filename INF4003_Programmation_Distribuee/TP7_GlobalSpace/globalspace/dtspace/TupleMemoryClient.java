...
public class TupleMemoryClient {

  private static final String JAR_NAME= "dtspace.jar";
  private static final String PACKAGE_NAME= "dtspace";
  private static final String APP_NAME= "TupleMemoryApplicationMaster";    
  private Configuration conf = new YarnConfiguration();

  public void run(String[] args) throws YarnException, IOException, InterruptedException {
    
    final Path jar_path = new Path(args[0]); // dans le HDFS
    final int nodes = Integer.parseInt(args[1]);
    ...
    submissionContext.setApplicationName("DtSpace");
  ...
  public static void main(String[] args) throws Exception {    
    TupleMemoryClient dtspaceClient = new TupleMemoryClient();
    dtspaceClient.run(args);
  }
}
